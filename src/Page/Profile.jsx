  ...
  return (
    <div>
      <div className="max-w-md p-8 sm:flex sm:space-x-6 dark:bg-gray-50 dark:text-gray-800">
        <div className="flex-shrink-0 w-full mb-6 h-44 sm:h-32 sm:w-32 sm:mb-0 bg-base-">
          {user && user.photoURL ? (
            <img
              src={user.photoURL}
              alt="Profile"
            ...
            <div className="w-30 h-30 rounded-full  flex items-center justify-center bg-gray-300">
